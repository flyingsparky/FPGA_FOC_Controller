...
//     .rst_n		( rst_n   		),
//     .clk  		( clk    		),
//     .i_ph		( theta	+ PI    ),  // theta is actual rotor angle, and electrical angle is shifted by pi for mag field perp to rotor flux
//     .o_sin		( ia      		)
// );
...
park park_inst (
    ...
    // .temp1      ( temp1         ),
    // .temp2      ( temp2         ),
    // .sim_mult_o1( sim_mult_o1   ),
    // .sim_mult_o2( sim_mult_o2   )
);
